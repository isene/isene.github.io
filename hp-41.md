...
![My collection, as it was](/assets/img/hp-home.jpg)

I sold the collection in 2026. The programs, modules and MCODE below stay here for anyone who still runs an HP-41.
...
- <a href="https://www.vim.org/scripts/script.php?script_id=1360"> HP-41 VIM syntax</a> - gives you syntax highlighting in VIM when writing HP-41 programs (<a href="https://github.com/isene/hp-41_vim" target="_blank" rel="noopener">code on Github</a>).
- <a href="https://www.vim.org/scripts/script.php?script_id=1361"> HP-41 VIM ftplugin</a> - gives you tools to more easily write HP-41 programs in VIM (<a href="https://github.com/isene/hp-41_vim" target="_blank" rel="noopener">code on Github</a>).
...
- <a href="https://www.hpmuseum.org">The Museum of HP Calculators</a>
- <a href="https://www.hpmuseum.org/forum/index.php" target="_blank" rel="noopener">The HP Forum, a discussion forum for HP calculator enthusiasts</a>
