...
layout: post
comments: true
title: Frame - the first Linux Assembly X server
...
The [phone got the same treatment](/2026/05/Nomad.html), with my own launcher, a daily personalized news digest and a pile of apps tailored for an audience of exactly one.
